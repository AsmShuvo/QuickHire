    ...
    <div className="bg-[#F8FAFF] min-h-screen py-16">
      <div className="container mx-auto px-6">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-16">
          <div>
            <h1 className="text-5xl font-extrabold text-[#0D0D0D] mb-4">
              Admin Dashboard
            </h1>
            <p className="text-gray-400 font-medium text-lg">
              Manage role acquisitions and active applications.
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-10 rounded-[32px] border border-gray-50 shadow-sm flex items-center gap-8">
            ...
            <div>
              ...
              <p className="text-3xl font-extrabold text-[#0D0D0D]">
                {jobs.length}
              </p>
            </div>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-gray-50/50">
                  <th className="px-10 py-6 text-[10px] font-extrabold text-gray-400 uppercase tracking-widest">
                    Company & Role
                  </th>
                  <th className="px-10 py-6 text-[10px] font-extrabold text-gray-400 uppercase tracking-widest">
                    Department
                  ...
                  <th className="px-10 py-6 text-[10px] font-extrabold text-gray-400 uppercase tracking-widest text-right">
                    Settings
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {jobs.map((job) => (
                  <tr
                    key={job._id}
                    className="hover:bg-[#F8FAFF] transition-all group"
                  >
                    <td className="px-10 py-8">
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          <p className="font-extrabold text-[#0D0D0D] text-xl group-hover:text-[#3B49DF] transition-colors">
                            {job.title}
                          </p>
                    ...
                    <td className="px-10 py-8">
                      <span className="text-gray-600 font-extrabold tracking-tight">
                        {job.category}
                      </span>
                    </td>
                    <td className="px-10 py-8">
                      <span className="bg-blue-50 text-[#3B49DF] px-5 py-2 rounded-full text-[10px] font-extrabold uppercase tracking-widest">
                        {job.type}
                      </span>
                    </td>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-6 overflow-y-auto">
          <div className="bg-white rounded-[50px] w-full max-w-2xl overflow-hidden my-auto shadow-2xl">
            <div className="p-12 lg:p-16">
              <h2 className="text-4xl font-extrabold text-[#0D0D0D] mb-4">
                Post a Job
              </h2>
              <p className="text-gray-400 font-medium mb-12">
                Submit new opportunities to the global community.
              </p>
              ...
              <form onSubmit={handleAddJob} className="space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    value={newJob.logo}
                    onChange={(e) =>
                      setNewJob({ ...newJob, logo: e.target.value })
                    }
